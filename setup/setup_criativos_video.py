#!/usr/bin/env python3
'''Setup 15 — Etapa 3: instalar skills de criativos de vídeo.

Copia as skills de vídeo do repositório para ~/.claude/skills/. A operação é
...
def main():
    ...
    print()
    print('📦 Resumo da instalação de skills de criativos de vídeo:')
    if installed:
    ...
    print('Etapa 3 concluída sem bloquear pelas pendências do repo.')
    return 0
